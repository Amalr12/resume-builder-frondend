  ...
  return (
    <>     <section class="hero-section">
      <div class="hero-overlay">
        ...
        <Link to={"/resumegenerator"}><button href="#" class="btn btn-custom px-4 py-2">MAKE YOUR RESUME</button></Link>
      </div>
    </section>
      ...
      <section class="container-fluid my-5 p-4">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6 text-center">
            <img src="https://www.my-resume-templates.com/wp-content/uploads/2023/05/student-resume-example.jpg" alt="Resume Examples" class="resume-img" />
          </div>
        </div>
      </section>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="row row-cols-4 g-3 justify-content-center">
              <div class="col"><img src="https://www.elementpack.pro/demo/wp-content/uploads/2018/08/02-4.jpg" alt="User 1" class="testimonial-img" /></div>
              <div class="col"><img src="https://www.elementpack.pro/demo/wp-content/uploads/2018/08/02-4.jpg" alt="User 2" class="testimonial-img" /></div>
              <div class="col"><img src="https://www.elementpack.pro/demo/wp-content/uploads/2018/08/02-4.jpg" alt="User 2" class="testimonial-img" /></div>
              <div class="col"><img src="https://www.elementpack.pro/demo/wp-content/uploads/2018/08/02-4.jpg" alt="User 2" class="testimonial-img" /></div>

              <div class="col"><img src="https://readymadeui.com/profile_5.webp" alt="User 1" class="testimonial-img" /></div>
              <div class="col"><img src="https://readymadeui.com/profile_5.webp" alt="User 1" class="testimonial-img" /></div>
              <div class="col"><img src="https://readymadeui.com/profile_5.webp" alt="User 1" class="testimonial-img" /></div>
              <div class="col"><img src="https://readymadeui.com/profile_5.webp" alt="User 1" class="testimonial-img" /></div>
